...
class _NetworkImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (imageUrl.isEmpty) {
      return placeholder?.call(context, imageUrl) ?? Icon(Icons.downloading);
          //SvgPicture.asset(Assets.icons.logo,height: height,width: width,fit: BoxFit.cover,);
    }
    if (kIsWeb) {
      return ClipRRect(
        borderRadius: borderRadius,
    ...
    return ClipRRect(
      ...
      child: CachedNetworkImage(
        ...
        placeholder: placeholder ?? (context, _) =>Icon(Icons.downloading),
            //SvgPicture.asset(Assets.icons.logo,height: height,width: width,fit: BoxFit.cover,),
        progressIndicatorBuilder: progressIndicatorBuilder,
        fadeInDuration: fadeInDuration,
        fadeOutDuration: fadeOutDuration,
